...
```
1. Read DEVOS/RUNTIME/ALGORITHM/LATEST to get current version string (e.g., "v3.7.0")
2. Read DEVOS/RUNTIME/ALGORITHM/v{VERSION}.md — the FULL spec, every line
...
```
Read DEVOS/MEMORY/LEARNING/SIGNALS/ratings.jsonl
...
```
Read all files in DEVOS/MEMORY/LEARNING/ALGORITHM/ (latest month first, then previous month)
...
```
Read DEVOS/MEMORY/LEARNING/FAILURES/ (latest month, plus ROOT_CAUSE_ANALYSIS.md)
...
Read files in DEVOS/MEMORY/LEARNING/ALGORITHM/ (2026-03/ then 2026-02/)

SOURCE 4: Failure patterns (Step 2d)
Read DEVOS/MEMORY/LEARNING/FAILURES/ latest month + ROOT_CAUSE_ANALYSIS.md
