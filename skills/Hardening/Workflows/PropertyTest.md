...
- Testing Doctrine Rule #11 — fast-check as approved primitive (`DEVOS/RUNTIME/DOCS/Testing/TestingDoctrine.md`)
- ISAFormat.md ISC Type Vocabulary — `bun-property` schema (`DEVOS/RUNTIME/DOCS/ISA/ISAFormat.md`)
- Algorithm v6.10.0 candidate — VERIFY hardening gate, PropertyAudit capability (`DEVOS/RUNTIME/ALGORITHM/v6.10.0.md`)
