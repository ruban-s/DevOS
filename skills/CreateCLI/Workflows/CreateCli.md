...
function loadConfig(): Config {
  // Canonical .env is ~/.claude/.env — never $DEVOS_CONFIG_DIR/.env, which
  // resolves to the dead DEVOS/.env path (public issue #1490).
...
**Reference:** `DEVOS/RUNTIME/DOCS/Tools/CliFirstArchitecture.md` (Configuration Flags section)
...
For more information, see DEVOS/Tools/{{CLI_NAME}}/README.md
...
See: DEVOS/Tools/{{CLI_NAME}}/README.md
```
...
**Report to user:**
```
✅ CLI Created: DEVOS/Tools/{{CLI_NAME}}/
...
Documentation: DEVOS/Tools/{{CLI_NAME}}/README.md
```
...
**Generated Output:**
```
✅ CLI Created: DEVOS/Tools/notioncli/
...
3. Read: DEVOS/Tools/notioncli/README.md
