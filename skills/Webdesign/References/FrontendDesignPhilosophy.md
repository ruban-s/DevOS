...
Both paths share this file's aesthetic doctrine. They differ in *who renders the design* — DirectDesign is the assistant writing code with this doctrine loaded; ClaudeDesign is Anthropic's claude.ai/design surface, which we drive live at whatever version is current.
