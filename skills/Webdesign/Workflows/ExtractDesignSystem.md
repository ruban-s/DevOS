...
```bash
bun DEVOS/skills/Webdesign/Tools/DriveClaudeDesign.ts upload "$TMP"
```
...
```bash
bun DEVOS/skills/Webdesign/Tools/DriveClaudeDesign.ts screenshot "$OUT/extracted-system.png"
```
...
```bash
bun DEVOS/skills/Webdesign/Tools/DriveClaudeDesign.ts export tokens "$OUT/tokens.json"
```
