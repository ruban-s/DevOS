...
```bash
OUT="${DEVOS_DOWNLOADS_DIR:-$HOME/Downloads}"/webdesign/redesign/$(date +%Y%m%d-%H%M%S)
mkdir -p "$OUT"
...
bun DEVOS/skills/Webdesign/Tools/VerifyDesign.ts "$URL" "$OUT/original-verify"
```
...
```bash
bun DEVOS/skills/Webdesign/Tools/DriveClaudeDesign.ts open
bun DEVOS/skills/Webdesign/Tools/DriveClaudeDesign.ts upload "$OUT/original.png"
bun DEVOS/skills/Webdesign/Tools/DriveClaudeDesign.ts prompt "$(cat $OUT/brief.md)"
```
...
```bash
bun DEVOS/skills/Webdesign/Tools/DriveClaudeDesign.ts screenshot "$OUT/redesigned.png"
bun DEVOS/skills/Webdesign/Tools/VerifyDesign.ts --compare "$OUT/original.png" "$OUT/redesigned.png" "$OUT/compare"
```
