 ...
 * and writes an EvalRun JSON to DEVOS/MEMORY/STATE/Evals-Results/<scenario-id>/<run-id>/.
 */
...
async function main(): Promise<void> {
  ...
  // Resolve against the enclosing DEVOS install (…/DEVOS/skills/…), never a fixed product name.
  const runDir = join(skillDir, "..", "..", "MEMORY", "STATE", "Evals-Results", scenarioId, runId);
