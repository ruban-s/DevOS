...
const REFLECTIONS = join(ROOT, 'DEVOS/MEMORY/LEARNING/REFLECTIONS/algorithm-reflections.jsonl');
const ASK_FIDELITY = join(ROOT, 'DEVOS/MEMORY/OBSERVABILITY/ask-fidelity.jsonl');
const DRAFTS_DIR = join(ROOT, 'DEVOS/PROFILE/CUSTOMIZATIONS/SKILLS/Evals/Suites/_drafts');
