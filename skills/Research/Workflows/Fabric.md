...
**Primary Skill:** `DEVOS/skills/Fabric/SKILL.md`
**Patterns Location:** `DEVOS/skills/Fabric/Patterns/`
...
Patterns are managed by the Fabric skill at `DEVOS/skills/Fabric/`.
...
```bash
ls DEVOS/skills/Fabric/Patterns/
```
...
**Full Pattern List:** `ls DEVOS/skills/Fabric/Patterns/`
**Fabric Skill:** `DEVOS/skills/Fabric/SKILL.md`
**Fabric Documentation:** https://github.com/danielmiessler/fabric
**Pattern Templates:** See `DEVOS/skills/Fabric/Patterns/official_pattern_template/`
